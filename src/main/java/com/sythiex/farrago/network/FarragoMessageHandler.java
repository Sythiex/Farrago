package com.sythiex.farrago.network;
...
public class FarragoMessageHandler implements IMessageHandler<BuildWandGuiMessage, IMessage>
{
	@Override
		...
		if(stack != null)
		{
			if(stack.getItem() instanceof ItemBuildWand)
			{
				...
				case 2:
					...
					return;
				default:
					FarragoMod.logger.error("Server build wand button id mismatch");
				}
			}
		}
	}
