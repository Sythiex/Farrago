...
public class ItemBuildWand extends Item
{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand)
	{
		...
		{
			player.openGui(FarragoMod.instance, FarragoGuiHandler.GUI_BUILD_WAND_ID, world, (int) player.posX, (int) player.posY, (int) player.posZ);
	...
	public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		if(!player.isSneaking())
		{
			...
			if(!tag.hasKey("pos1"))
			{
				...
				FarragoMod.logger.info("Position 1 set: " + pos.toString());
			...
			if(!tag.hasKey("pos2"))
			{
				...
				FarragoMod.logger.info("Position 2 set: " + pos.toString());
			...
			if(!tag.hasKey("pos3") && (tag.getInteger("shape") == BuildWandShape.CYLINDER.ordinal() || tag.getInteger("shape") == BuildWandShape.RHOMBUS.ordinal() || tag.getInteger("shape") == BuildWandShape.TRIANGLE.ordinal()))
			{
				...
				FarragoMod.logger.info("Position 3 set: " + pos.toString());
			}
