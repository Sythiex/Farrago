...
public class ContainerBuildWand extends Container
{
	...
	public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, EntityPlayer player)
	{
		...
		{
			if(inventoryPlayer.getStackInSlot(slotId).getItem() == FarragoItems.itemBuildWand)
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex)
	{
		...
		{
			FarragoMod.logger.error("Invalid slot index moving stack to/from Creative Build Wand. Index: " + sourceSlotIndex);
			return ItemStack.EMPTY;
		}
